...
LifeMapApp.Routing = (function (LifeMapApp, Backbone) {
    ...
    Routing.Router = Backbone.Router.extend({
        routes: {
            ...
            "membership/registration/:registrationId/confirmEmail/:confirmationId": "confirmRegistration"
        ...
        confirmRegistration: function (registrationId, confirmationId) {
            LifeMapApp.MembershipApp.confirmEmail(registrationId, confirmationId);
        }
